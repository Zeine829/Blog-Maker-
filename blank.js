...
function viewoption(){
  ...
  <br>
  <br>
  <button onclick = "addelement('a')" class = "bt">Add link</button>
  
 
  <br>
  <br>
  <button onclick = "showFileInput('img')" class = "bt">IMG</button>
  <br>
  <br>
    <button onclick = "showFileInput('video')" class = "bt">Video</button>
...
//funções de detalhes
function textalign(){
  layout.style.body = "text-align: center;"
}
...
function save() {
 localStorage.setItem('project',layout.innerHTML);
}
